          ...
          <Col xs={12} md={6} className='text-info'>
              ...
              <Row className="links-get-in-touch">
                <Col className='links-social-network'>
                  <a className='my-icon-class' href="https://github.com/AlvaroValle-FS93" target='_blank'>
                    <img src="/images/icons/github-footer.svg" alt="github logo" />
                  </a>
                  <a className='my-icon-class' href="https://www.linkedin.com/in/alvaro-valle-melgarejo/" target='_blank'>
                    <img src="/images/icons/linkedin-footer.svg" alt="linkedin logo" />
                  </a>
                  <a className='my-icon-class' href="mailto:alvaro.valle.melga@hotmail.com">
                    <img src="/images/icons/email-footer.svg" alt="email logo" />
                  </a>
                </Col>

                <Col className='buttons'>
                  <a href='#contact' className='my-primary-button' >Get in Touch!</a>
                </Col>
              </Row>
          </Col>
